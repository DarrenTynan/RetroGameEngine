...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Angled headers"))
    {
        ...
        if (ImGui::BeginTable("table_angled_headers", columns_count, table_flags, ImVec2(0.0f, TEXT_BASE_HEIGHT * 12)))
        {
            ...
            ImGui::TableAngledHeadersRow(); // Render angled headers for all columns with the ImGuiTableColumnFlags_AngledHeader flag.
            ImGui::TableHeadersRow();       // Render remaining headers and allow access to context-menu and other functions.
