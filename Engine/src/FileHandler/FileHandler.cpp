...
//    void RGE_FILEHANDLER::FileHandler::OpenConfigFile()
//    {
...
//    }
    ...
    int RGE_FILEHANDLER::FileHandler::LoadConfigFile(const std::string& path)
    {
        // Open the file
...
//        rapidjson::Document doc;
        ...
        std::cout << doc["configuration"]["window_title"].GetString() << std::endl;
        std::cout << doc["configuration"]["window_width"].GetInt() << std::endl;
        std::cout << doc["configuration"]["window_height"].GetInt() << std::endl;
