...
struct TextLabelComponent
{
     ...
     * @param isFixed
     */
    TextLabelComponent(glm::vec2 position = glm::vec2(0,0), const std::string& text = "Debug Info", const std::string& assetId = "arial-font", const SDL_Color& color = {255,255,255}, bool isFixed = true) {
